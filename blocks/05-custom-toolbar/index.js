...
export default registerBlockType(
    'gutenbergblocks/custom-toolbar',
    {
        title: __( 'Example - Custom Toolbar', 'gutenbergblocks' ),
        description: __( 'An example of how to add a custom buttom to the block toolbar.', 'gutenbergblocks'),
